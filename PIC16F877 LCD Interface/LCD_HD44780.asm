...
;LCD_HD44780.c,139 :: 		void WriteLCDLine3(const char *s)    // length of s should be 16 for 16x2 LCD and 20 for 20x2 LCD
;LCD_HD44780.c,141 :: 		GotoYXPositionOnLCD(LCD_LINE3, 0);     // Goto 1,0 location
	MOVLW      2
	MOVWF      FARG_GotoYXPositionOnLCD_LineNumber+0
	CLRF       FARG_GotoYXPositionOnLCD_OFFSET+0
	CALL       _GotoYXPositionOnLCD+0
;LCD_HD44780.c,142 :: 		WriteStringToLCD(s);
...
;LCD_HD44780.c,148 :: 		void WriteLCDLine4(const char *s)    // length of s should be 16 for 16x2 LCD and 20 for 20x2 LCD
;LCD_HD44780.c,150 :: 		GotoYXPositionOnLCD(LCD_LINE4, 0);     // Goto 1,0 location
	MOVLW      3
	MOVWF      FARG_GotoYXPositionOnLCD_LineNumber+0
	CLRF       FARG_GotoYXPositionOnLCD_OFFSET+0
	CALL       _GotoYXPositionOnLCD+0
;LCD_HD44780.c,151 :: 		WriteStringToLCD(s);
